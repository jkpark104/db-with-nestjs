...
export class Ch02PrismaController {
  ...
  findProductReviews(@Param('id', ParseIntPipe) id: number) { return this.service.findProductReviews(id); }

  @Get('categories/:id/products')
  findProductsByCategory(@Param('id', ParseIntPipe) id: number) { return this.service.findProductsByCategory(id); }
